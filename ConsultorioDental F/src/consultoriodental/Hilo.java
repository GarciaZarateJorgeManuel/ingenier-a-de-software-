...
public class Hilo extends Thread { 
    ...
    private final int TIEMPO = 2000;         // tiempo en milisegundos que estara activa la ventana 
    ...
    public static void main(String[] args) { 
        Hilo hilo = new Hilo(); 
        hilo.agregarTexto("Hola mundo!", 0); 
        hilo.start(); 
        hilo.agregarTexto("Hola mundo!", 1); 
        hilo.agregarTexto("Hola mundo!", 2); 
    } 
    ...
    class Ventana extends JDialog { 
        ...
        private void ubicacionVentana() { 
            ...
            setLocation(tamanioX, tamanioY - BARRA_DE_ESTADO); 
        } 
